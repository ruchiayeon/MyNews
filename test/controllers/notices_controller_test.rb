...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { created_on: @notice.created_on, link: @notice.link, title: @notice.title, writer: @notice.writer } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { created_on: @notice.created_on, link: @notice.link, title: @notice.title, writer: @notice.writer } }
